...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_length = volume_of_cube(2)
    assert_equal(8, cube_length)
  end
  ...
  def test_days_until_christmas()
    days = date_until_christmas('25-12-2016', '15-02-2016')
    assert_equal( 314, days)
  end

  # #Given a date of birth, calculate how old a person born on that date would be
  def test_age_of_person()
    age = age_of_person('15-02-2016', '05-08-1980')
    assert_equal(35, age)
